...
exports.exercises = [
  ...
  // ---------- TENDINOPATHY — SHOULDER ----------
  {
    ...
    region: "Shoulder",
    phase: "Educate",
    name: "Speed’s Isometric Band Hold",
    focus: "biceps tendon isometric",
    description: "Elbow extended, shoulder flexed ~90°, palm up. Press gently into band or wall without moving.",
    duration: "Hold 10–20 sec, 3–5 rounds",
    difficulty: "Intermediate",
    instructions: [
      "Elbow straight, shoulder flexed ~90°, palm up",
      "Press into band or wall without moving",
  ...
  },
  {
    ...
    region: "Shoulder",
    phase: "Educate",
    name: "Isometric Scaption Hold (Thumb Up)",
    focus: "supraspinatus isometric",
    description: "Arm lifted ~30–45° from body, thumb up. Press into wall or hold light band tension.",
    duration: "Hold 10–20 sec, 3–5 rounds",
    difficulty: "Intermediate",
    instructions: [
      "Lift arm ~30–45°, thumb up",
      "Press lightly into wall/band",
  ...
  },
  {
    ...
    region: "Shoulder",
    phase: "Educate",
    name: "Banded External Rotation (Neutral)",
    focus: "infraspinatus/teres minor neutral ER",
    description: "Elbow at side, band at light tension. Rotate hand outward slightly, hold 10 sec.",
    duration: "10s holds x 6–8",
    difficulty: "Beginner",
    instructions: [
      "Elbow at side, ribs stacked",
      "Rotate hand outward slightly",
  ...
  },
  {
    ...
    region: "Shoulder",
    phase: "Educate",
    name: "Banded External Rotation with Flexion",
    focus: "integrated cuff + upward rotation",
    description: "Band around wrists, slight ER tension. Raise arms to 90° flexion, maintain ER.",
    duration: "6–8 slow reps",
    difficulty: "Intermediate",
    instructions: [
      "Create light ER tension",
      "Raise to ~90° without rib flare",
  ...
  {
    id: "HIP_GLUTE_MED_TENDINOPATHY_EDU_SIDE_ABDUCTION_EIR",
    region: "Hip / Groin",
    phase: "Educate",
    name: "Side-Lying Abduction (Extension + Internal Rotation)",
    focus: "glute med posterior fibers",
    description: "Top leg slightly back and rotated inward; lift slowly to hip height, hold 2s, lower slow.",
    duration: "6–10 reps",
    difficulty: "Intermediate",
    instructions: [
      "Bottom leg bent; top leg slightly behind",
      "IR bias; lift to hip height; 2s hold",
  ...
  },
  {
    ...
    region: "Hip / Groin",
    phase: "Reset",
    name: "Wall Lean Isometric (Single-Leg)",
    focus: "lateral hip stability",
    description: "Press outer knee/ankle gently into wall; ribs stacked; pelvis level.",
    duration: "10–20s holds x 3–5",
    difficulty: "Beginner",
    instructions: [
      "Stand tall; press gently into wall",
      "Pelvis level; ribs stacked",
  ...
  },
  {
    ...
    region: "Hip / Groin",
    phase: "Rebuild",
    name: "Loaded Hip Hitch / Pelvic Drop",
    focus: "frontal-plane control",
    description: "Stand on step; lower opposite pelvis slightly; lift using stance glute.",
    duration: "6–8 reps/side",
    difficulty: "Advanced",
    instructions: [
      "Keep knee tracking; pelvis level",
  ...
  // ---------- TENDINOPATHY — KNEE ----------
  {
    ...
    focus: "patellar tendon isometric",
    description: "Band behind knees; sit back slightly; ribs down. Hold 20–30 sec, 3–5 rounds.",
    duration: "20–30s holds",
    difficulty: "Intermediate",
    instructions: [
      "Lean back into band; shins upright",
  ...
  },
  {
    ...
    region: "Knee",
    phase: "Educate",
    name: "Nordic Isometric Lean",
    focus: "proximal hamstring load",
    description: "Kneel with ankles anchored; lean forward slightly and hold tension.",
    duration: "5–10s holds x 6–8",
    difficulty: "Intermediate",
    instructions: [
      "Light forward lean; hold tension",
  ...
  {
    id: "ANKLE_ACHILLES_EDU_ISO_HEEL_RAISE_HOLD",
    region: "Foot / Ankle",
    phase: "Educate",
    name: "Isometric Heel Raise Hold",
    focus: "mid-portion achilles load",
    description: "Rise onto toes; hold mid-range position ~20s.",
    duration: "~20s holds x 3–5",
    difficulty: "Intermediate",
    instructions: [
      "Rise to mid-range; hold steady",
  ...
  },
  {
    ...
    region: "Foot / Ankle",
    phase: "Educate",
    name: "Eversion Isometric Hold",
    focus: "peroneal tendon isometric",
    description: "Band around forefoot; press outward gently; hold 10–15s.",
    duration: "10–15s holds x 6–8",
    difficulty: "Beginner",
    instructions: [
      "Press outward gently into band",

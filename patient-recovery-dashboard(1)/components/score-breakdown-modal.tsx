      ...
      <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
              ...
              <div key={index} className="flex items-start space-x-3 p-3 rounded-lg border border-gray-200">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-sm font-medium ${component.achieved ? "text-primary" : "text-muted-foreground"}`}
                    >
                      +{component.points}
                    </span>
                  </div>
          ...
          <div className="bg-primary/10 rounded-lg p-4 border border-primary/20">
            <h3 className="font-semibold text-foreground mb-2">Score Interpretation</h3>

...
interface ClinicianInputProps {
  formData: {
    recoveryMilestone: boolean;
    clinicalProgressVerified: boolean;
  };
  onChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
}

export function ClinicianInput({ formData, onChange }: ClinicianInputProps) {
  return (
